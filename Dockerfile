...
RUN mkdir GRCm38 && cd GRCm38 && wget ftp://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_mouse/release_M15/gencode.vM15.pc_transcripts.fa.gz && \
	mv gencode.vM15.pc_transcripts.fa.gz gencode.vM15.transcripts.fa.gz && \
